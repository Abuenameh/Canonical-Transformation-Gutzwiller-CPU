...
void phasepoints(Parameter& xi, double theta, queue<Point>& points, multi_array<vector<double>, 2 >& f0, multi_array<double, 2 >& E0res, multi_array<double, 2 >& Ethres, multi_array<double, 2 >& fs, progress_display& progress) {
